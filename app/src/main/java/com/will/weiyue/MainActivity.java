...
import com.will.weiyue.ui.personal.PersonalsFragment;
...
public class MainActivity extends BaseActivity {
    ...
    public void bindView(View view, Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            ...
            mFragments[1] = DetailFragment.newInstance();
            mFragments[2] = JanDanFragment.newInstance();
            mFragments[3] = PersonalsFragment.newInstance();
            ...
            mFragments[1] = findFragment(DetailFragment.class);
            mFragments[2] = findFragment(JanDanFragment.class);
            mFragments[3] = findFragment(PersonalsFragment.class);
        }
